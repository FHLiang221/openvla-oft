...
def kinova_coke_pick_same_start_transform(traj: Dict[str, Any]) -> Dict[str, Any]:
    """Transform for Kinova Coke Pick dataset - no changes needed, proprio already 8D."""
    # Dataset already has proper 8D proprio vector [x,y,z,qx,qy,qz,qw,gripper]
    return traj
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "kinova_coke_pick_same_start": kinova_coke_pick_same_start_transform,
}