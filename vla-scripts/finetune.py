...
# Finetune on Jaco 500 base:
# torchrun --standalone --nnodes 1 --nproc_per_node 1 vla-scripts/finetune.py --vla_path openvla/openvla-7b --data_root_dir /home/fhliang/tensorflow_datasets --dataset_name jaco_dataset --run_root_dir ./checkpoints/jaco_dataset_oft --use_l1_regression True --use_diffusion False --use_film False --num_images_in_input 1 --use_proprio True --batch_size 1 --grad_accumulation_steps 64 --learning_rate 5e-4 --num_steps_before_decay 100000 --max_steps 50000 --save_freq 5000 --image_aug True --lora_rank 32 --merge_lora_during_training False --wandb_entity freddieliang-usc --wandb_project openvla_jaco --run_id_note jaco_dataset_base
