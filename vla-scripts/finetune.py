...
class FinetuneConfig:
    # fmt: off
    vla_path: str = "moojink/openvla-7b-oft-finetuned-libero-spatial-object-goal-10"  # Path to OpenVLA model (on HuggingFace Hub or stored locally)
    ...
    # JSON-based augmentation settings (alternative to YAML adversarial prompts)
    aug_json_path: Optional[str] = None              # Path to augmented_prompts.json file
    aug_types: Optional[str] = None                  # Comma-separated augmentation types to use
                                                     #   Options: logical,object_synonym,verb_synonym,phrasing,synonym_combined,synonym_mixed
                                                     #   e.g. --aug_types "logical,verb_synonym"
    aug_split: str = "train"                         # Which split to use from augmented prompts ("train" or "test")
...
def finetune(cfg: FinetuneConfig) -> None:
    ...
    batch_transform = RLDSBatchTransform(
        ...
        aug_json_path=cfg.aug_json_path,
        aug_types=cfg.aug_types,
        aug_split=cfg.aug_split,
    )
...
#FineTune SimplerEnv
"""
CUDA_VISIBLE_DEVICES=0 torchrun --standalone --nnodes 1 --nproc_per_node 1 vla-scripts/finetune.py --vla_path openvla/openvla-7b --data_root_dir ~/tensorflow_datasets --dataset_name simpler_env_switch_dataset --run_root_dir ./checkpoints/simpler_oft --use_l1_regression true --use_diffusion false --use_film false --num_images_in_input 1 --use_proprio true --per_device_batch_size 1 --gradient_accumulation_steps 64 --learning_rate 5e-4 --num_steps_before_decay 100000 --max_steps 150000 --save_freq 5000 --image_aug true --lora_rank 32 --wandb_entity freddieliang-usc --wandb_project openvla_repl --run_id_note simpler_OFT --merge_lora_during_training false
"""
# to merge later
"""
...
# ORIGINAL MODEL
# CUDA_VISIBLE_DEVICES=0,1 torchrun --standalone --nnodes 1 --nproc_per_node 2 vla-scripts/finetune.py --vla_path openvla/openvla-7b --data_root_dir ./modified_libero_rlds --dataset_name libero_spatial_no_noops --run_root_dir ./checkpoints/libero_spatial_oft_base --use_l1_regression True --use_diffusion False --use_film False --num_images_in_input 2 --use_proprio True --batch_size 1 --grad_accumulation_steps 32 --learning_rate 5e-4 --num_steps_before_decay 100000 --max_steps 150000 --save_freq 5000 --image_aug True --lora_rank 32 --wandb_entity freddieliang-usc --wandb_project openvla_repl --run_id_note liberoSpatial_oft_base

# Sophie Finetune:
# CUDA_VISIBLE_DEVICES=0,1 torchrun --standalone --nnodes 1 --nproc_per_node 2 vla-scripts/finetune.py --vla_path openvla/openvla-7b --data_root_dir /home/freddie/tensorflow_datasets --dataset_name kinova_coke_pick_same_start --run_root_dir ./checkpoints/kinova_coke_oft --use_l1_regression True --use_diffusion False --use_film False --num_images_in_input 1 --use_proprio True --batch_size 1 --grad_accumulation_steps 32 --learning_rate 5e-4 --num_steps_before_decay 100000 --max_steps 50000 --save_freq 5000 --image_aug True --lora_rank 32 --merge_lora_during_training False --wandb_entity freddieliang-usc --wandb_project openvla_kinova --run_id_note kinova_coke_adv --adv_prompts_yaml ./kinova_prompts.yaml --adv_replace_prob 1.0 --adv_log_examples_every 100

# Jaco on Adv
# CUDA_VISIBLE_DEVICES=0,1 torchrun --standalone --nnodes 1 --nproc_per_node 2 vla-scripts/finetune.py --vla_path openvla/openvla-7b --data_root_dir /home/freddie/tensorflow_datasets --dataset_name jaco_dataset --run_root_dir ./checkpoints/jaco_dataset_oft --use_l1_regression True --use_diffusion False --use_film False --num_images_in_input 1 --use_proprio True --batch_size 1 --grad_accumulation_steps 32 --learning_rate 5e-4 --num_steps_before_decay 100000 --max_steps 50000 --save_freq 5000 --image_aug True --lora_rank 32 --merge_lora_during_training False --wandb_entity freddieliang-usc --wandb_project openvla_jaco --run_id_note jaco_dataset_base --adv_prompts_yaml /home/freddie/project/openvla-oft/jaco_all.yaml --adv_replace_prob 1.0 --adv_log_examples_every 100

# Google Robot on ERT
# CUDA_VISIBLE_DEVICES=0,1 torchrun --standalone --nnodes 1 --nproc_per_node 2 vla-scripts/finetune.py --vla_path openvla/openvla-7b --data_root_dir /home/freddie/tensorflow_datasets --dataset_name simpler_env_success_dataset --run_root_dir ./checkpoints/google_robot_dataset --use_l1_regression True --use_diffusion False --use_film False --num_images_in_input 1 --use_proprio True --batch_size 1 --grad_accumulation_steps 32 --learning_rate 5e-4 --num_steps_before_decay 100000 --max_steps 50000 --save_freq 5000 --image_aug True --lora_rank 32 --merge_lora_during_training False --wandb_entity freddieliang-usc --wandb_project openvla_google_robot --run_id_note google_robot_dataset_ERT --adv_prompts_yaml /home/freddie/project/openvla-oft/ERT.yaml --adv_replace_prob 1.0 --adv_log_examples_every 100
# CUDA_VISIBLE_DEVICES=1 torchrun --standalone --nnodes 1 --nproc_per_node 1 vla-scripts/finetune.py --vla_path openvla/openvla-7b --data_root_dir /home/freddie/tensorflow_datasets --dataset_name simpler_env_success_dataset --run_root_dir ./checkpoints/google_robot_dataset --use_l1_regression True --use_diffusion False --use_film False --num_images_in_input 1 --use_proprio True --batch_size 1 --grad_accumulation_steps 64 --learning_rate 5e-4 --num_steps_before_decay 100000 --max_steps 50000 --save_freq 5000 --image_aug True --lora_rank 32 --merge_lora_during_training False --wandb_entity freddieliang-usc --wandb_project openvla_google_robot --run_id_note google_robot_dataset_ERT --adv_prompts_yaml /home/freddie/project/openvla-oft/ERT.yaml --adv_replace_prob 1.0 --adv_log_examples_every 100