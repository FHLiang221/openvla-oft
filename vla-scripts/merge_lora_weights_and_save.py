...
Usage:
    python vla-scripts/merge_lora_weights_and_save.py \
        ...
        --lora_finetuned_checkpoint_dir /home/freddie/project/openvla-oft/checkpoints/google_robot_dataset/openvla-7b+simpler_env_success_dataset+b64+lr-0.0005+lora-r32+dropout-0.0--image_aug--google_robot_dataset_ERT--20000_chkpt
"""
...
# huggingface-cli upload fhliang/google_robot_ERT_20k /home/freddie/project/openvla-oft/checkpoints/google_robot_dataset/openvla-7b+simpler_env_success_dataset+b64+lr-0.0005+lora-r32+dropout-0.0--image_aug--google_robot_dataset_ERT--20000_chkpt